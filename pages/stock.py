...
class StockPage(BasePage):
    ...
    def add_stock(self, stock_name, part_number, serial_number, tgl_masuk, expired_date, jumlah_unit, keterangan):
        ...
        self.driver.find_element(self.By.ID, "nama_barang").send_keys(stock_name)
        ...
        self.driver.find_element(self.By.ID, "part_number").send_keys(part_number)

        self.driver.find_element(self.By.ID, "ref_des").send_keys(serial_number)
        ...
        self.driver.find_element(self.By.ID, "jumlah_unit").send_keys(jumlah_unit)
        ...
        self.driver.find_element(self.By.ID, "keterangan").send_keys(keterangan)
