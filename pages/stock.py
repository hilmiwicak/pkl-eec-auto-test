...
class StockPage(BasePage):
    ...
    def add_stock(self, stock_name, part_number, serial_number, tgl_masuk, expired_date, jumlah_unit, keterangan):
        ...
        self.driver.find_element("nama_barang").send_keys(stock_name)
        ...
        self.driver.find_element("part_number").send_keys(part_number)

        self.driver.find_element("ref_des").send_keys(serial_number)

        self.driver.find_element("tgl_masuk").send_keys(tgl_masuk)

        self.driver.find_element("expired").send_keys(expired_date)

        self.driver.find_element("button_kurs_beli").click()

        self.driver.find_element("jumlah_unit").send_keys(jumlah_unit)

        stock_status_element = self.driver.find_element("status")
        ...
        self.driver.find_element("keterangan").send_keys(keterangan)
    ...
    def edit_stock(self):
        ...
        name_element = self.driver.find_element("nama_barang")
        name_element.clear()
        ...
        ref_des_element = self.driver.find_element("ref_des")
        ref_des_element.clear()
        ref_des_element.send_keys(self.util.random_serial_number())

        self.driver.find_element("tgl_masuk").send_keys("10262023")

        expired_element = self.driver.find_element("expired")
        expired_element.location_once_scrolled_into_view
        expired_element.send_keys("11262023")

        unit_element = self.driver.find_element("jumlah_unit")
        unit_element.clear()
        ...
        description_element = self.driver.find_element("keterangan")
